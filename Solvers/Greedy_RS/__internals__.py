...
from Solvers.Greedy_RS.greedy_rs import GreedyRS
...
class Solver(SliceMappingSolver):
    ...
    def Solve(self,) -> SliceMappingProblem:
        ...
        tim = 0
        try:
            sol = self.GreedyRS(PHY=self.problem.PHY, SLICE_SET=self.problem.SLICES_SET, profiler=self.__profiler__, timelimit=self.timelimit)
